...
export default function App() {
  ...
  const printModulo = (modulo) => {
    ...
    const rows_km = (modulo.kmRows||[]).map(r=>'<tr><td>'+r.tipo+'</td><td style="text-align:right">'+r.km+'</td><td>'+r.data+'</td><td>'+(r.targa||'—')+'</td><td>'+(r.modello||'—')+'</td><td style="text-align:right">'+(r.indennizzo?'€ '+r.indennizzo:'—')+'</td><td style="text-align:right">'+(r.totale?'€ '+r.totale:'—')+'</td><td>'+(r.note||'—')+'</td></tr>').join('');
